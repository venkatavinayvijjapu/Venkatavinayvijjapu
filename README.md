...
You shall paint all the non-broken tiles that are not already painted. When you paint a tile you can choose from 109
 shades of grey, indexed from 1
 to 109
. You can paint multiple tiles with the same shade. Formally, painting the wall is equivalent to assigning a shade (an integer between 1
 and 109
...
Compute the minimum possible total contrast of the wallYou have to paint with shades of grey the tiles of an n×n
 wall. The wall has n
 rows of tiles, each with n
 tiles.
...
Compute the minimum possible total contrast of the wall.You have to paint with shades of grey the tiles of an n×n
 wall. The wall has n
 rows of tiles, each with n
 tiles.
